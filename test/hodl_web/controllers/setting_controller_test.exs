defmodule HodlWeb.SettingControllerTest do
  use HodlWeb.ConnCase

  alias Hodl.Accounts

  @create_attrs %{setting_key: "some setting_key", value: "some value"}
  ...
  describe "update setting" do
    ...
    test "redirects when data is valid", %{conn: conn, setting: setting} do
      ...
      assert html_response(conn, 200) =~ "some updated setting_key"
    end
